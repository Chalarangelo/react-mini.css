...
var _idGenerator = __webpack_require__(41);
...
var Tabs = function (_React$Component) {
	...
	function Tabs(props) {
		...
		var state = {
			group: 'tab_group_' + (0, _idGenerator2.default)(),
			tabs: []
		};
		_this.props.tabs.forEach(function (propTab) {
			var tab = propTab;
			tab.id = 'tab_' + (0, _idGenerator2.default)();
			state.tabs.push(tab);
		});
		_this.state = state;
		return _this;
	...
	_createClass(Tabs, [{
		...
		value: function render() {
			...
			this.state.tabs.forEach(function (tab) {
				kids.push(_react2.default.createElement('input', { type: 'radio', name: group, id: tab.id, defaultChecked: true, 'aria-hidden': true }));
				kids.push(_react2.default.createElement('label', { htmlFor: tab.id, 'aria-hidden': true }, tab.labelText));
				kids.push(_react2.default.createElement('div', {}, tab.children));
			});
			return _react2.default.createElement('div', { className: 'tabs' }, kids);
		}
		// this.state.tabs.forEach(function(tab){
